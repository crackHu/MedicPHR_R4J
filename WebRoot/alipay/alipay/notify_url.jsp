...
System.out.println("进入异步请求通知------------");
	...
	if (AlipayNotify.verifyNotify(params)) {//验证成功
		...
		if (trade_status.equals("TRADE_FINISHED")) {
			...
			json.put("order_sn", out_trade_no);
			JSONObject json1 = new JSONObject();
			json1.put("din", json);
			BoBase boNameMgr = (BoBase) wac.getBean("boVdsUpdataOrder");
			JSONObject jDataOut = boNameMgr.callMethod("updataOrder",
					json1);
			System.out.println(jDataOut);
